...
export const sections: Section[] = [
  ...
  },
  {
    ...
    description: 'La section de Kénitra représente une communauté dynamique d\'étudiants engagés dans leur réussite académique.',
    ...
    bureau: [
      ...
      },
      {
        ...
        role: 'Adjointe chargée d\'organisation',
        isMainMember: false
      },
      {
        name: 'TABARA CISSÉ',
      ...
      {
        name: 'HENRIETTE ÉLODIE DIOUMA DIOUF',
        role: 'Adjointe chargée culturelle',
        isMainMember: false
      },
      {
      ...
      {
        name: 'MOUHAMADOU DOUDOU SËCK',
        role: 'Chargé religieux',
        isMainMember: false
      },
      {
        name: 'MOUHAMED DIAKHATÉ',
        role: 'Chargé des relations extérieures',
        isMainMember: false
      },
      {
      ...
      {
        name: 'MOUSKÉBA DALAFINA SIDIBÉ',
        role: 'Présidente cellule féminine',
        isMainMember: false
      },
      {
  ...
  },
  {
    ...
    bureau: [
      ...
      {
        name: 'DIOP El Hadji Mouhamadou Fadilou Mbacké',
        role: 'Chargé de communication',
      ...
      {
        name: 'GAYE Aissatou',
        role: 'Chargée des affaires culturelles et de l’organisation',
        isMainMember: false
      },
      {
        name: 'NDIAYE Cheikh',
